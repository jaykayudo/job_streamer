...
def test_application(db_session):
    application = Application(
            ...
            job_url="https://www.google.com", job_location="Test Job Location",
            job_salary="Test Job Salary", job_company="Test Job Company",
...
def test_saved_preference(db_session):
    category = Category(name="Test Category")
    saved_preference = SavedPreference(name="Test Saved Preference", module_name="Test Module")
